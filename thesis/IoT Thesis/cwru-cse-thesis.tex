...
% Author and title
\author{\uppercase{Douglas C. Burhanna}}
\title{Design and Development of a Modular Internet of Things Curriculum}
...
%\includeonly{content/01-Introduction, content/02-BackgroundResearch}
%\includeonly{content/02-BackgroundResearch}
%\includeonly{content/03-ModularFramework}
%\includeonly{content/04-PythonModule}
%\includeonly{content/05-SimpleRemoteModule}
%\includeonly{content/06-Conclusion}
%\includeonly{content/07-Futurework}
...
\signaturepage
\sign[Advisor]{Dr. Kenneth Loparo}{Chair}{Electrical, Computer and Systems Engineering}
\sign{Dr. Name}{Member}{Electrical, Computer and Systems Engineering}
\sign{Dr. Name}{Member}{Electrical, Computer and Systems Engineering}
...
% commenting out for now... dcb 5/20
...
\include{content/02-BackgroundResearch}
\include{content/03-ModularFramework}
\include{content/04-PythonModule}
\include{content/05-MicroRemoteModule}
\include{content/06-MicroMonitorModule}
\include{content/07-MicroDataCollectionModule}
\include{content/08-SBCRemoteModule}
\include{content/09-SBCMonitorModule}
\include{content/10-SBCDataCollectionModule}
\include{content/11-SimulationModule}
\include{content/12-Conclusion}
